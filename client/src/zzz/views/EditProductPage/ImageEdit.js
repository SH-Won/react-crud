...
import {uploadImage,deleteImages,getProductDetail} from '../../../_actions/product_actions'
...
function ImageEdit(props) {
    ...
    const deleteOriginalImage =(image)=>{
        let imageArray = [...props.originalImage]
        const currentIndex = props.originalImage.indexOf(image)
        imageArray.splice(currentIndex,1);
        props.handleOriginalImages(imageArray);
    }
        ...
        <div style={{display:'flex',justifyContent:'space-between'}}>
             <Dropzone
               ...
               <div style={{display:'flex', width:'350px',height:'240px',overflowX:'scroll'}}>
                  {props.originalImage &&  props.originalImage.map((image,index)=>(
                       <div key={index} onClick={()=>deleteOriginalImage(image)} >
